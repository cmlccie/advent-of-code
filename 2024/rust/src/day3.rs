...
pub fn part2<P: AsRef<Path> + ?Sized>(input: &P) -> i64 {
    ...
    enabled_sections.iter().fold(0, |acc, section| {
        acc + mul_regex
...
mod tests {
    ...
    fn test_example_solution_part1() {
        assert_eq!(
            ...
            solution("../data/day3/example-part1-answer.txt").unwrap()
        );
    }
    ...
    fn test_example_solution_part2() {
        assert_eq!(
            ...
            solution("../data/day3/example-part2-answer.txt").unwrap()
        );
    }
    ...
    fn test_part1_solution() {
        assert_eq!(
            ...
            solution("../data/day3/input-part1-answer.txt").unwrap()
        );
    }
    ...
    fn test_part2_solution() {
        assert_eq!(
            ...
            solution("../data/day3/input-part2-answer.txt").unwrap()
        );
    }
}
